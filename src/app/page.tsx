...
// Define strict types for the merged course data to avoid using 'any'
...
export default async function HomePage() {
  ...
  // 1. Fetch stats for all courses concurrently for maximum performance
    ...
    >
      ...
      <section id="trending-courses" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {trendingCourses.map((course: CourseWithStats, index: number) => {
